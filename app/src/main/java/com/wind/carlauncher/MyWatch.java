...
public class MyWatch extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float x0 = (float) (2 * mPadding + mStrokeWidth + mRadius * (1 - cos));
        float y0 = (float) (2 * mPadding + mStrokeWidth + mRadius * (1 - sin));
        float x1 = (float) (2 * mPadding + mStrokeWidth + mRadius - (mRadius - mLength1) * cos);
        float y1 = (float) (2 * mPadding + mStrokeWidth + mRadius - (mRadius - mLength1) * sin);
